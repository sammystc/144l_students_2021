...
```{r message = F}
count.tab <- read_rds("~/Documents/144l_students_2021/Input_Data/week9/144Lseqtab-nochimtaxa.rds") #table of counts for each sequence in each sample, update the file path for the .rds file you generated with dada2
tax.tab <- read_rds("~/Documents/144l_students_2021/Input_Data/week9/144L_taxa.rds") #table that matches ASV to sequence, update file path to your own file
...
metadata_OG <- read_excel("~/Documents/144l_students_2021/Input_Data/week9/144L_2021_metadata.xlsx", sheet = "Metadata")
glimpse(metadata_OG)
...
metadata_mock <- read_csv("~/Documents/144l_students_2021/Input_Data/week9/144L_2018_metadata.csv")
...
```{r}
saveRDS(sweet.tab, "~/Documents/144l_students_2021/Output_Data/week9/Custom_ASV_Table.rds")
saveRDS(sub_ps, "~/Documents/144l_students_2021/Output_Data/week9/phyloseq_obj.rds")
saveRDS(ps_min, "~/Documents/144l_students_2021/Output_Data/week9/subsampled_phyloseq_obj.rds")
saveRDS(alphadiv, "~/Documents/144l_students_2021/Output_Data/week9/alphadiv.rds")

...
``` r
count.tab <- read_rds("~/Desktop/144l_students_2021/Input_Data/week 7/seqtab-nochimtaxa.rds") #table of counts for each sequence in each sample
tax.tab <- read_rds("~/Desktop/144l_students_2021/Input_Data/week 7/taxa.rds") #table that matches ASV to sequence
...
metadata_OG <- read_excel("~/Desktop/144l_students_2021/Input_Data/week7/ACIDD_Exp_BactAbund.xlsx", sheet = "Metadata")
glimpse(metadata_OG)
```
...
``` r
metadata_doc <- read_rds("~/Desktop/144l_students_2021/Input_Data/week7/ACIDD_Exp_Processed_DOC_BGE.rds")
...
A1: By using the sub\_ps function, we are subsetting from the taxa table
and remove any organisms that belong to the mitochondria family as well
as anything from the cholorplast order.
...
A2: Sequencing depth means the amount of samples that was read an x
amount of times. For example the first bar shows 2 samples that have
been read between 5500-6500 times.
...
A3: No subsampling did not have a large effect on beta diversity because
the mean values before and after subsampling are very close in value,
meaning subsampling has a small effect.
...
```
    ...
    ## Square root transformation
    ## Wisconsin double standardization
    ## Run 0 stress 0.0383222 
    ## Run 1 stress 0.155114 
    ## Run 2 stress 0.0383222 
    ## ... Procrustes: rmse 4.263441e-06  max resid 8.78804e-06 
    ## ... Similar to previous best
    ## Run 3 stress 0.0383222 
    ## ... Procrustes: rmse 1.976392e-06  max resid 4.789883e-06 
    ## ... Similar to previous best
    ## Run 4 stress 0.3121125 
    ## Run 5 stress 0.0383222 
    ## ... Procrustes: rmse 3.850105e-06  max resid 7.85217e-06 
    ## ... Similar to previous best
    ## Run 6 stress 0.0383222 
    ## ... Procrustes: rmse 4.682466e-06  max resid 9.021645e-06 
    ## ... Similar to previous best
    ## Run 7 stress 0.0383222 
    ## ... Procrustes: rmse 3.7257e-06  max resid 7.399275e-06 
    ## ... Similar to previous best
    ## Run 8 stress 0.0383222 
    ## ... Procrustes: rmse 2.111826e-06  max resid 4.588724e-06 
    ## ... Similar to previous best
    ## Run 9 stress 0.0383222 
    ## ... Procrustes: rmse 4.750809e-06  max resid 7.978956e-06 
    ## ... Similar to previous best
    ## Run 10 stress 0.0383222 
    ## ... Procrustes: rmse 4.685524e-06  max resid 8.335821e-06 
    ## ... Similar to previous best
    ## Run 11 stress 0.0383222 
    ## ... Procrustes: rmse 3.038321e-06  max resid 7.17043e-06 
    ## ... Similar to previous best
    ## Run 12 stress 0.155114 
    ## Run 13 stress 0.0383222 
    ## ... Procrustes: rmse 1.814901e-06  max resid 3.755078e-06 
    ## ... Similar to previous best
    ## Run 14 stress 0.0383222 
    ## ... Procrustes: rmse 5.396207e-06  max resid 1.350395e-05 
    ## ... Similar to previous best
    ## Run 15 stress 0.0383222 
    ## ... Procrustes: rmse 1.638933e-06  max resid 4.855238e-06 
    ## ... Similar to previous best
    ## Run 16 stress 0.0383222 
    ## ... Procrustes: rmse 1.593889e-06  max resid 3.278406e-06 
    ## ... Similar to previous best
    ## Run 17 stress 0.0383222 
    ## ... Procrustes: rmse 2.152328e-06  max resid 4.46133e-06 
    ## ... Similar to previous best
    ## Run 18 stress 0.0383222 
    ## ... Procrustes: rmse 5.786766e-06  max resid 1.265847e-05 
    ## ... Similar to previous best
    ## Run 19 stress 0.0383222 
    ## ... Procrustes: rmse 4.029962e-06  max resid 9.499023e-06 
    ## ... Similar to previous best
    ## Run 20 stress 0.0383222 
    ## ... Procrustes: rmse 4.602822e-06  max resid 1.331434e-05 
    ## ... Similar to previous best
    ## *** Solution reached
...
A4: Data from the NOT subsetted data set was plotted along with
subsampled data set. Since the two plots look similar, we will move
forward with the standardized where we normalized the read counts.
...
A5: At time 0, the communities are similar to each other because they
are close in distance. However, over time, they become more dissimilar
and spread further apart. This causes beta diversity to increase. The
ash leachate and control samples are clustered closely together in terms
of time scale: time 0 both are similar and t4 communities are also
similar for both treatment and control.
...
A6: The plots show that the control sample has a lot less variability
compared to the ash leachate treatment. Furthermore, the control tends
to have higher average levels of diversity than ash leachate. 3 out of 4
plots have statistically significant data. Over time, richness decreased
over time but Shannon index did not vary much over time.
...
A7: Alteromonodales and Oceanspirllales both increase in abundance in
the ash leachate treatment but not in the control. On the other hand,
Cellvibrionales decreases in the ash leachate treatment but remains high
in the control.
...
``` r
saveRDS(sweet.tab, "~/Desktop/144l_students_2021/Output_Data/week6//Custom_ASV_Table.rds")
saveRDS(sub_ps, "~/Desktop/144l_students_2021/Output_Data/week6/phyloseq_obj.rds")
  saveRDS(ps_min, "~/Desktop/144l_students_2021/Output_Data/week6/subsampled_phyloseq_obj.rds")
saveRDS(alphadiv, "~/Desktop/144l_students_2021/Output_Data/week6/alphadiv.rds")
```
